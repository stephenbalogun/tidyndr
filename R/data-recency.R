...
#'   \item{recency_test_name}{Namme of testing kit used for the recent infection testing}
...
#'   \item{viral_load_result}{TThe viral load count of the client}
...
#'   \item{pcr_lab}{laboratory where recency viral load is analysed}
